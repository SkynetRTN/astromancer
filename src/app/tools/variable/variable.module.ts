...
import {
  VariableLightCurveEchartComponent
} from "./light-curve/variable-light-curve-echart/variable-light-curve-echart.component";
import {
  VariablePeriodFoldingEchartComponent
} from "./period-folding/variable-period-folding-echart/variable-period-folding-echart.component";
import {
  VariablePeriodogramEchartComponent
} from "./periodogram/variable-periodogram-echart/variable-periodogram-echart.component";
